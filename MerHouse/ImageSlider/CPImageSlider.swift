		...
		for index in 0..<count
		{
			...
			if allowCircular && images.count != 0
			{
				if index == 0
                {
                    ...
                    //imageV.sd_setImage(with: URL(string: images.last!)!, placeholderImage: UIImage(named: "Logo")!, options: SDWebImageOptions.refreshCached)
...
//                    imageV.sd_setImage(with: URL(string: images.first!)!, placeholderImage: UIImage(named: "Logo")!, options: SDWebImageOptions.refreshCached)
				}
				else
				{
                    imageV.image = UIImage(named:images[index - 1])
//                    imageV.sd_setImage(with: URL(string: images[index - 1])!, placeholderImage: UIImage(named: "Logo")!, options: SDWebImageOptions.refreshCached)
				}
			}
			else
			{
...
//                imageV.sd_setImage(with: URL(string: images[index])!, placeholderImage: UIImage(named: "Logo")!, options: SDWebImageOptions.refreshCached)
			}
